...
import {getInfo} from "../../Services/SettingService";
...
<Foods></Foods>
        ...
        <div className="row">
            <div className="col-sm-12 col-lg-4  d-flex align-items-center flex-column my-sm-4 my-lg-0">
                <h4>آدرس</h4>
                <span className="footer-info">{info.address}</span>
            </div>

            <div className="col-sm-12 col-lg-4  d-flex align-items-center flex-column  my-sm-4 my-lg-0">
                <h4>ساعات کاری</h4>
                <span className="footer-info">{info.workours}</span>
            </div>
